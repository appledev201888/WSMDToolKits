...
Pod::Spec.new do |s|
  ...
  s.name         = "WSMDToolKits"
  s.version      = "0.0.1"
  s.summary      = "A short description of WSMDToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/WSMDToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/WSMDToolKits.git", :tag => "#{s.version}" }
